SELECT 
	...
	RIGHT('0000'+CONVERT(VARCHAR,ROW_NUMBER()OVER(ORDER BY SNO,MERCHANT_NO_ACT_M)),4) AS ROWID,
	MONTH_DAY ,
	MERCHANT_NO_ACT_M ,
...
--AND MERCHANT_NO_ACT_M IN (SELECT DISTINCT MERCHANT_NO_ACT_M FROM GM_MERCHANT_ACT WHERE INVOICE_RULE = 'N')