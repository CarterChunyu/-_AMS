...
SELECT LEFT(@firstDate,6),c.MERCHANT_NAME,b.TR_SYSTEM_NAME,d.TRANS_DESC,SUM(TRANS_AMT) AS SUM_AMT FROM icashbatchdb.itrans.[{0}].TM_SETTLE_DATA_D a
...
GROUP BY c.MERCHANT_NAME,b.TR_SYSTEM_NAME,d.TRANS_DESC
ORDER BY 4 DESC,3