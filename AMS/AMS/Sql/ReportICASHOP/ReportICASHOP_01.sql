...
--●明細_機構日期
SELECT *
INTO #TargetData_OpenPoint_TransDetail_DateMerchant
...
SELECT SUBSTRING(ot.WriteOffNo,7,8) [機構日期]
	,ot.CptDate
...
FROM #TargetData_OpenPoint_TransDetail_DateMerchant ot WITH(NOLOCK)
...
DROP TABLE #TargetData_OpenPoint_TransDetail_DateMerchant
